...
PROTOBUF_CONSTINIT const uint32_t TensorProto_DataType_internal_data_[] = {
    1900544u, 0u, };
static ::google::protobuf::internal::ExplicitlyConstructed<::std::string>
    TensorProto_DataType_strings[29] = {};
...
const ::std::string& TensorProto_DataType_Name(TensorProto_DataType value) {
  static const bool kDummy = ::google::protobuf::internal::InitializeEnumStrings(
      TensorProto_DataType_entries, TensorProto_DataType_entries_by_number, 29,
...
const ::std::string& Version_Name(Version value) {
  static const bool kDummy = ::google::protobuf::internal::InitializeEnumStrings(
      Version_entries, Version_entries_by_number, 15,
      Version_strings);
  (void)kDummy;
...
PROTOBUF_NDEBUG_INLINE TypeProto_Opaque::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::onnx::TypeProto_Opaque& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        domain_(arena, from.domain_),
        name_(arena, from.name_) {}
