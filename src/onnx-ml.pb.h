...
inline constexpr TensorProto_DataType TensorProto_DataType_DataType_MAX =
    static_cast<TensorProto_DataType>(28);
inline bool TensorProto_DataType_IsValid(int value) {
  return 0 <= value && value <= 28;
}
inline constexpr int TensorProto_DataType_DataType_ARRAYSIZE = 28 + 1;
...
inline constexpr Version Version_MAX =
    static_cast<Version>(14);
inline bool Version_IsValid(int value) {
  return 0 <= value && value <= 14;
}
inline constexpr int Version_ARRAYSIZE = 14 + 1;
...
/* @@protoc_insertion_point(class_definition:onnx.TensorProto) */ {
 ...
 public:
  ...
  static constexpr DataType FLOAT6E2M3 = TensorProto_DataType_FLOAT6E2M3;
  static constexpr DataType FLOAT6E3M2 = TensorProto_DataType_FLOAT6E3M2;
